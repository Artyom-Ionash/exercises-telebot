...
# --------------------------------------------------------------------------------------------
# Python Discord Bot. Часть 1
#
# Задачи на урок:
# - Создать новую директорию под проект и расположить в ней начальную настройку Discord Bot'а
# - Написать функционал инициализации БД
# - Написать функционал начала игры и добавления информации об игроке в БД
# --------------------------------------------------------------------------------------------
